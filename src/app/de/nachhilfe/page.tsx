...
export default function DeutscheNachhilfe() {
  ...
  const testimonials = [
    {
      ...
      text: 'Dank TutorGo hat unser Sohn wieder Freude am Lernen gefunden. Die 3-Phasen-Methodik hat wirklich funktioniert - aus der Abwärtsspirale wurde eine Erfolgsspirale. Wir können TutorGo nur weiterempfehlen.',
      rating: 5
    },
    {
      name: 'Familie Rietmann aus Zürich',
      text: 'Die 6-Schritte-Methode von TutorGo hat unserer Tochter geholfen, ihre Lernblockaden zu überwinden. Sie ist jetzt selbstbewusster und ihre Noten haben sich deutlich verbessert.',
      rating: 5
    }
  ]
    ...
    <>
      ...
      <LPSection
        ...
        bulletPoints={[
          ...
          'Resultat: Potenzial wird nicht ausgeschöpft, Zukunft ist gefährdet'
        ]}
        buttonText="Jetzt Nachhilfe-Lehrer finden"
        imageSrc="/images/Tochter_5_Klasse_Alleine_stark-frustriert.jpg"
        imageAlt="Frustrierte Schülerin alleine am Tisch - Die Abwärtsspirale der Lernfrustration"
        imagePosition="left"
              ...
              <div className="relative bg-gradient-to-br from-green-50 to-white p-8 rounded-2xl shadow-xl border border-green-100">
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <p className="text-sm font-medium text-gray-800">Lerntyp analysieren</p>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <p className="text-sm font-medium text-gray-800">Lernblockaden auflösen</p>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <p className="text-sm font-medium text-gray-800">Eigenständiges Lernen erreichen</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <LPSection
        ...
        content="Aus der Abwärtsspirale zur Erfolgsspirale - überzeugen Sie sich selbst, wie TutorGo das Leben von Schülern und Familien verändert hat."
        buttonText="Jetzt Nachhilfe-Lehrer finden"
      ...
      {/* 3 Steps */}
      <LPSteps
        title="3 einfache Schritte zu besseren Noten"
        steps={steps}
        ctaText="Jetzt Nachhilfe-Lehrer finden"
        isEnglish={false}
        onCtaClick={() => router.push('/lehrer-finden')}
      />
